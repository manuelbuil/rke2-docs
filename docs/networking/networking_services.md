...
ingress-nginx becomes EOL in March 2026. RKE2 will still include ingress-nginx in v1.36 and v1.37 but with a deprecated status. No new images with fixes should be expected after March 2026. Please switch to Traefik or become a [Rancher Prime user](https://www.suse.com/products/rancher/) for an extended support period. 
:::
